...
var FlowralAction = (function (_FlowralDispatcher) {
  _inherits(FlowralAction, _FlowralDispatcher);

  function FlowralAction() {
    _classCallCheck(this, FlowralAction);

    _get(Object.getPrototypeOf(FlowralAction.prototype), "constructor", this).apply(this, arguments);
  }
